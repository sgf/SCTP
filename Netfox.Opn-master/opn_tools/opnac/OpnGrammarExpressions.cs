...
{
	// The representation of OPN started from a full c# 3.0 grammar provided with Irony.
	...
	[Language("OPN", "0.1", "The Open Protocol Notation Grammar")]
	public partial class OpnGrammar : Grammar
	{
		...
		public OpnGrammar() : base(true)
		{
			this.GrammarComments = "This is an incomplete grammar for Microsoft OPN language.\r\n";
	   ...
	   */
			...
			builtin_type.Rule = integral_type | "bool" | "decimal" | "float" | "double" | "string" | "object" | "stream" | "binary" | "guid" ;
